 ...
 */
export declare function expandMentions(messages: readonly UserMessage[], cwd: string | undefined, config: ResolvedConfig, signal: AbortSignal): Promise<UserMessage[]>;
 ...
 */
export declare function mentionPreStep(agent: MentionAgent, config: ResolvedConfig, isEnabled: () => boolean, messages: readonly UserMessage[], signal: AbortSignal, next: () => Promise<PreStepDecision>): Promise<PreStepDecision>;
